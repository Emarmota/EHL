...
class ControlParentalAdapter (val context : Context, var listener: OnAdapterListener, var layoutInflater: Int, var layoutInflaterChild:Int?) : RecyclerView.Adapter<ControlParentalAdapter.ActivityViewHolder>(){
    ...
    private fun SetRecycler(recyclerView: RecyclerView?, layoutInflaterChild:Int){
        val childRecyclerAdapter = ControlParentalAdapterChild(context, object: ControlParentalAdapter.OnAdapterListener{}, layoutInflaterChild)
