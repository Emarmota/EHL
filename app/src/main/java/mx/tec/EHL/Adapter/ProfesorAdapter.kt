...
class ProfesorAdapter (val context : Context, var listener: OnAdapterListener, var layoutInflater: Int, var layoutInflaterChild:Int?) : RecyclerView.Adapter<ProfesorAdapter.ActivityViewHolder>(){
    ...
    private fun SetRecycler(recyclerView: RecyclerView?, layoutInflaterChild:Int){
        val childRecyclerAdapter = ProfesorAdapterChild(context, object: ProfesorAdapter.OnAdapterListener{}, layoutInflaterChild)
